...
A1: I found 59 records of pg county public schools systems vendors

```{r}
pg_schools <- md_payments |>
  filter(str_detect(vendor_name, 'PRINCE GEORGES PUBLIC')| str_detect(vendor_name, 'PG COUNTY')| str_detect(vendor_name, "PG SCHOOL"))
...
A2:2020 had the largest total amoung, im wondering why it is more as we get closer to current year
...
A4: Stem Cell research funding has decreased over time, with the highest amount of money granted in 2009.
