...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: There are 8 columns, ObjectID, Zipcode, Zipname, Zipcode1, Shape_Leng, existing, shape_area, and geometry**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer: We see more of what the column names mean. For example, Zipname is county, Zipcode1 is the ZCTA but Zipcode 2 is the full zipcode. The shape length and area tell us the size of the shapes of the counties or areas, and the shape shows us what shape the different areas will be. The numbers are the coordinates, but I don't fully understand how they work.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The output is a map of Maryland with the 526 areas that are written in the data. Zipcodes represent population on map**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Nothing, it installs the tigris library**
...
**Task** Run the following code. Describe the output in the space below. **Answer: There are way more columns than there were before**
...
**Task** Run the following code. Describe the output in the space below. **Answer: The data in the geometry section is different**
...
**Task** Run the following code. Describe the output in the space below. **Answer: It is a map, split up by county**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This is a much more detailed map, including the zips within each county**
...
**Task** Run the following code. Describe the output in the space below. **Answer: we can see where the forclosures are happening based on zipcode. We get 547 entries for march of 2023**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This merges the zipcode data with the forclosure data in order to create a map based on forclosures**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This shows us where the most forclosures occured based on zipcode using color coded zipcodes representing the number of forclosures**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This gets the data from the census that is needed to**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Below are the counties and their shapes and populations**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This is a chart representing date, type, county, and \# of notices.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: We have a similar output as before, creating the shape and population of the counties**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This shows the \# of foreclosures by county date and type**
...
**Task** Run the following code. Describe the output in the space below. **Answer: this just joins the code and creates a complete list with types of notices**
...
**Task** Run the following code. Describe the output in the space below. **Answer: there is a map of md by county with rates based on color. it is a bit messy with the names of the counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: There is a map with different colors, without county names based on forclosures**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: There is a similar map with more decimals for \# of foreclosures, more specific color scheme**
