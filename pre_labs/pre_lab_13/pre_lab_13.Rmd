...
**Task** Run the following code and describe the dataframe it outputs. **Answer: This is a chart with the state, numbers of pupils, who they voted for, their population change, and the state's GDP growth.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: There doesn't seem to be a super strong correlation between the population change and the GDP growth.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: There is a weak relationship between the GDP growth and the numbers of pupils in 2021.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: There is a slightly negative correlation of GDP growth and growth per student. There is a stronger correlation between pop change and GDP growth.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: This tells us that there is a statistical significance with a negative correlation**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: The output is the correlation coefficient, and it shows that there is a negative correlation.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: This shows us that gdp growth was higher under the Biden vote than the Trump vote**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The output is a Welch Two Sample t-test that has a high p value meaning that there is no or low significance.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: two sample t-test with a very low p value meaning that the p value is very significant.**
