...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: The mutate is making a column for months, the label=TRUE shortens the name to 3 letters, the group_by is grouping the data by months, the summarize and arrange are showing the number of calls in descending order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: nothing, blank space**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Now we see a bar graph that is organized by calls per month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: this organized the number of calls from lowest to highest per month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: this flips the bar chart, and makes it easier to see the difference between each month, as well as the name of the month and the number per month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: the background grey color is gone, which makes it even easier to read.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: this added a theme (with a background color of blue.) However, the words reorder by month and total number of calls is on the y-axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: much more organized, and we have a title. The y and x-axis titles make much more sense.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: we see the date and the total number of calls per date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: this is a very confusing graph with the spikes per day in calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: this is more in-depth with more spikes, but the x-axis is a mess. The dates are unreadable.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: we can read the dates on the bottom**
