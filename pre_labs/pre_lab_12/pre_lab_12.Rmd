...
**Task** Run the following code and describe the dataframe it outputs. **Answer: We just see the data from the original release with the links to the press releases.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: We have capitalized dog, lowercased dog, and cat. We also have a comma counted**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: we have a list of unique words for the whole text that is 647,091 entries long.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: It is not very interesting because filler words are the most common. they dont tell us what he is actually talkign about**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: It is more interesting because we can see what words are actually unique to this specific speech.**
...
**Task** Run the following code and describe the results. **Answer: We see the top words based on year, joined togehter. This is interesting because we can see the most popular words in press releases over the course of 3 years.**
...
**Task** Run the following code and describe the results. **Answer: These are the most unique words for 2021, bigrams not single words.**
...
**Task** Run the following code and describe the results. **Answer: This creates a dataframe for the top 10 into combination of 2 words instead of single words**
...
**Task** Run the following code and describe the results. **Answer: This bigram from 2023 is interesting, covid 19 is no longer at the top of the most mentioned word combinations**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: They all had similar unique words, I don't think many of them seem incorrect**
